...
func resolveOpenAIAccountUpstreamModelForRequest(account *Account, requestedModel string, requireCompact bool) string {
	// Forward checks the raw Chat Completions fallback before passthrough. Its
	// local compact bridge applies compact_model_mapping for compact requests,
	// so scheduler-side model resolution must mirror the actual wire model.
